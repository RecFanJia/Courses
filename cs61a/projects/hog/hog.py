...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    extrascore=3*abs(player_score%10 - abs(opponent_score//10%10))
    return 1 if extrascore==0 else extrascore
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while score <= goal:
      ...
      while opponent_score <= goal:
           if strategy(score, opponent_score) != x:
              return False
           opponent_score +=1             
      score +=1
    return True
...
def max_scoring(dice=six_sided, samples_count=1000):
    ...
    while num_rolls<=9:
          num_rolls+=1
          current_average_score=average_roll_dice(num_rolls,dice)
          if  current_average_score>max_average_value:
              max_average_value=current_average_score
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    return 0 if sus_update(0, score,opponent_score,dice=six_sided)-score >=threshold else num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    return 0 if sus_update(0, score,opponent_score,dice=six_sided)-score >= 9 else 6
    # END PROBLEM 12
