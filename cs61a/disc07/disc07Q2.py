...
class Button:
    ...
    def press(self):
        ...
        self.pressed += 1
        "*** YOUR CODE HERE ***"
        self.output(self.letter) if self.caps_lock.pressed %2 == 0 else self.output(self.letter.upper())
        return self
...
class Keyboard:
    ...
    def __init__(self):
        self.typed = []
        self.keys = {c: Button(c, self.typed.append) for c in LOWERCASE_LETTERS}#output is add to self.typed
